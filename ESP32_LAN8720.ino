#include <ETH.h>
/*
// Ethernet settings for JL1101
#define ETH_TYPE ETH_PHY_JL1101           // JL1101 PHY
#define ETH_ADDR 0                        // PHY address (usually 0 or 1)
#define ETH_POWER_PIN 0                   // Power control pin (if needed)
// Define GPIO pins
...
void setup() {
  ...
  /*
  // Initialize Ethernet with JL1101
  if (!ETH.begin(ETH_PHY_JL1101, ETH_ADDR, ETH_MDC_PIN, ETH_MDIO_PIN, ETH_POWER_PIN, ETH_CLK_MODE)) {
